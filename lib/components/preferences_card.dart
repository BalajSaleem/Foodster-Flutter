...
class _PreferencesCardState extends State<PreferencesCard> {
  ...
  Column buildPreferences() {
    return Column(
        children: [
          ...
          SizedBox(height: 8,),
          !isUpdateLoading
              ? BigButton(text: "Update", onClick: updateUser,)
              : Loader()
        ]
    );
  }
  ...
  Row buildDietTypeDropDown() {
    return Row(
      ...
      children: [
      Text("Diet Type", style: TextStyle(color: Colors.grey[400],
        fontSize: 16,
  ...
  Row buildPreference(String fieldName, String unit, int from, int to,
    ...
    return Row(
      ...
      children: [
        Expanded(flex: 5,
            child: Text(fieldName, style: TextStyle(color: Colors.grey[400],
                fontSize: 16,
                fontWeight: FontWeight.w300),)),
        Expanded(
          flex: 2,
